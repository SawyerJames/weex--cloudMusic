...
public class WXPageActivity extends AbsWeexActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.translucentStatusBar(this);
    ...
    public void translucentStatusBar(Activity activity) {
        ...
        TextView textview_bar = (TextView) findViewById(R.id.textview_bar);
        LinearLayout.LayoutParams textview_bar_params = (LinearLayout.LayoutParams) textview_bar.getLayoutParams();
        textview_bar_params.height = statusBarHeight1;
        textview_bar.setLayoutParams(textview_bar_params);
    }
